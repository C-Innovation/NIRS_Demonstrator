...
namespace NIRS_Demonstrator
{
    ...
    /// 
    /// </summary>
    public class ThicknessAnimation : IDisposable
    {
        ...
        public async void RunAsync(Thickness? thicknessStart,
                                    Thickness? thicknessStop,
                                    AvaloniaProperty thicknessProperty,
                                    Control control,
            ...
            Animation __anim = new Animation()
            {
                ...
                Children =
                {
                    new KeyFrame
                    {
                        ...
                        Setters =
                        {
                            new Setter(thicknessProperty, thicknessStart)
                        }
                    },
                    new KeyFrame
                    {
                        ...
                        Setters =
                        {
                            new Setter(thicknessProperty, thicknessStop)
                        }
                    }
                }
            };
            _AnimationState[control] = true;
            control.SetValue(thicknessProperty, thicknessStop);
